...
function GenerateSuperIndex(superSquares){
	for(var j=0;j<superSquares; ){
		...
		if(superIndexArr.indexOf(superIndex)!=true && badIndexArr.indexOf(superIndex)!=true){ //compare for existing this generated value in array of bad indexes and in array of super indexes
...
function AddBadCells(){
	...
	for(var key in badIndexArr){
		var ind=+badIndexArr[key];
